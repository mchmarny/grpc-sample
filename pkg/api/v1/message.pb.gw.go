...
func request_MessageService_Send_0(ctx context.Context, marshaler runtime.Marshaler, client MessageServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterMessageServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MessageServiceClient) error {
	...
	mux.Handle("GET", pattern_MessageService_Send_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_MessageService_Send_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_MessageService_Send_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_MessageService_Send_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"v1", "send", "message"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_MessageService_Send_0 = runtime.ForwardResponseMessage
)
